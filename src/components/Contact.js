...
<section className="text-gray-400 bg-gray-900 body-font relative">
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" height="100%" title="map" className="absolute inset-0" frameBorder="0" marginHeight="0" marginWidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3399.4969404828475!2d74.29822767616993!3d31.565417844914183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39191cb1d5b91c33%3A0xc41ebd057dc163c7!2sSessions%20Court%20Lahore!5e0!3m2!1sen!2suk!4v1695417224047!5m2!1sen!2suk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
      ...
      <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <Link className="text-indigo-400 leading-relaxed">Chmehrozqayyumadv@gmail.com</Link>
